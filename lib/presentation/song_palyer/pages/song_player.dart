...
import 'package:spotifyclone/presentation/song_palyer/bloc/song_player_cubit.dart';
import 'package:spotifyclone/presentation/song_palyer/bloc/song_player_state.dart';
...
class SongPlayerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 🔥 build nama file + encode
    final fileName = '${song.artist} - ${song.title}.mp3';
    final encodedFileName = Uri.encodeComponent(fileName);

    final songUrl = AppURLs.songSupabaseStorage + encodedFileName;
    return Scaffold(
      appBar: BasicAppbar(
  ...
  Widget _songCover(BuildContext context) {
    ...
    // 🔥 build nama file + encode
    final fileName = '${song.artist} - ${song.title}.jpg';
    final encodedFileName = Uri.encodeComponent(fileName);

    final imageUrl = AppURLs.supabaseStorage + encodedFileName;
    return Container(
